    ...
    public partial class AddCustomerInvitations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInvitations_OrganizationId_CustomerId",
                table: "CustomerInvitations",
                columns: new[] { "OrganizationId", "CustomerId" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInvitations_OrganizationId_Email_AcceptedAt_RevokedAt",
                table: "CustomerInvitations",
                columns: new[] { "OrganizationId", "Email", "AcceptedAt", "RevokedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInvitations_TokenHash",
                table: "CustomerInvitations",
                column: "TokenHash",
                unique: true);
        }
